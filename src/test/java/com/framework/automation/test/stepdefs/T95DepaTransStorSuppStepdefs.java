...
public class T95DepaTransStorSuppStepdefs {
    static AndroidDriver<AndroidElement> driver;
    static int testCase=95;
    ...
    public void User_reach_From_Dashboard_to_DepartmentTransfer() throws IOException, InterruptedException {
    ...
    public void check_in_DepartmentTransfer_Page_update_UPC() throws InterruptedException {
    ...
    @Then("Verify in Some Sections are Available in DepartmentTransfer When Source is Supply")
    public void verify_in_Some_Sections_are_Available_in_DepartmentTransfer_When_Source_is_Supply() throws InterruptedException, IOException {
    ...
    public void user_is_DepartmentTransfer_Verify_Able_to_Reach_Scan_Items_Page_and_Send_to_Trans() throws IOException, InterruptedException {
        ...
        String fileName1="D:\\SOF-automation\\IMAF-main\\ScreenShots\\T95" +".jpg";
