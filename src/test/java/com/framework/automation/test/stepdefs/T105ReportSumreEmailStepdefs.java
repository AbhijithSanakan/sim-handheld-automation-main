...
public class T105ReportSumreEmailStepdefs {

    static AndroidDriver<AndroidElement> driver;
    static int testCase=105;
    static String actualText;
    static String expectedText;

    @Given("User Verify Login and Reach To Click Hamburger Icon")
    public void user_Verify_Login_and_Reach_To_Click_Hamburger_Icon() throws IOException, InterruptedException {
    ...
    @Then("User Check and Verify in Report and select Summary")
    public void user_Check_and_Verify_in_Report_and_select_Summary() {
        ...
        System.out.println("The  Next status is" + nxt);
    ...
    @Then("User Verify all in Report Date in Report page")
    public void user_Verify_all_in_Report_Date_in_Report_page() throws InterruptedException, IOException {

        MobileElement DepartDDChs = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.view.ViewGroup/android.widget.TextView");
        DepartDDChs.click();

        MobileElement FromDate = (MobileElement) driver.findElementByXPath("//android.view.View[@content-desc=\"01 August 2022\"]");
        FromDate.click();
        ...
        String fileName1="D:\\SOF-automation\\IMAF-main\\Deviations\\T1035-Steps7" +".jpg";
