...
public class T97DepTransSorsSuplDesSuplStepdefs {

    static AndroidDriver<AndroidElement> driver;
    static int testCase=97;
    ...
    public void User_Reach_From_Dashboard_to_Department_Transfer() throws InterruptedException, IOException {
    ...
    public void check_in_Department_Transfer_Page_Update_Supply() throws InterruptedException {

        MobileElement SorceSupply = (MobileElement) driver.findElementById("com.sof.retail:id/sourceSupplyRadioBtn");
        SorceSupply.click();Thread.sleep(5000);
        ...
        expectedText = "Awards and Events (7 )";
    ...
    @Then("Verify in Some Sections are Available in DepartmentTransfer When Source And Destination is Supply")
    public void verify_in_Some_Sections_are_Available_in_DepartmentTransfer_When_Source_And_Destination_is_Supply() throws IOException, InterruptedException {
        ...
        String fileName="D:\\SOF-automation\\IMAF-main\\Deviations\\T95-Step-11" +".jpg";
    ...
    public void user_Able_to_Reach_Scan_Items_Page_and_Send_to_Trans() throws IOException, InterruptedException {
        ...
        warok.click();Thread.sleep(15000);
        ...
        File file= ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        String fileName="D:\\SOF-automation\\IMAF-main\\ScreenShots\\T97" +".jpg";
        FileUtils.copyFile(file,new File(fileName));
