...
public class T109ReportAnaliyPrntStepdefs {
    static AndroidDriver<AndroidElement> driver;
    static int testCase=109;
    static String actualText;
    static String expectedText;

    @Given("User Verify Login and Reach in Hamburger Icon")
    public void user_Verify_Login_and_Reach_in_Hamburger_Icon() throws IOException, InterruptedException {
    ...
    @Then("User Check and Verify in Report and Select Analysis")
    public void user_Checkand_Verify_in_Report_and_Select_Analysis() throws IOException {
        ...
        String fileName="D:\\SOF-automation\\IMAF-main\\Deviations\\T109-Steps2" +".jpg";
        FileUtils.copyFile(file,new File(fileName));
    }

    @Then("User Select all in Report Date in Report page and select Date From&To")
    public void user_Select_all_in_Report_Date_in_Report_page_and_select_Date_From_To() throws InterruptedException, IOException {
        ...
        String fileName1="D:\\SOF-automation\\IMAF-main\\Deviations\\T109-Steps7,8" +".jpg";
    ...
    @When("User Going to Summery Page for Generate Report")
    public void user_Going_to_Summery_Page_for_Generate_Report() throws InterruptedException {
