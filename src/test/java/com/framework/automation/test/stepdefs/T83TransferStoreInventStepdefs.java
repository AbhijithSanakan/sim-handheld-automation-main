...
public class T83TransferStoreInventStepdefs {
    static AndroidDriver<AndroidElement> driver;
    static int testCase=83;
    static String keys =null;
    static String transNum;
    static String actualText;
    static String expectedText;

    @Given("User is reach From Dashboard to Transfer Out")
    public void user_is_reach_From_Dashboard_to_Transfer_Out() throws IOException, InterruptedException {
    ...
    @Then("Check in Transfer Out page")
    public void check_in_Transfer_Out_page() throws InterruptedException {
        ...
        driver.findElementById("com.sof.retail:id/viewDividerFirst").click();
    ...
    @Then("Verify in Some Sections are Available in Transfer Out when source is Inventory")
    public void verify_in_Some_Sections_are_Available_in_Transfer_Out_when_source_is_Inventory() throws InterruptedException {
    ...
    public void user_is_Verify_Able_to_Reach_Enter_Items_Page_and_Send() throws InterruptedException, IOException {
        ...
        String fileName="D:\\SOF-automation\\IMAF-main\\ScreenShots\\T83" +".jpg";
