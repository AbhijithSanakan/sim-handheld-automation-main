...
public class T47DROrderShelfRecuringStepdefs {
    static AndroidDriver<AndroidElement> driver;
    static int testCase=46;
    static String keys =null;
    static String transNum;
    static String actualText;
    static String expectedText;

    @Given("User Verify Login and Going To Recurring Minimums Page Screen")
    public void user_Verify_Login_and_Going_To_Recurring_Minimums_Page_Screen() throws IOException, InterruptedException {
        ...
        expectedText = "By Department";TestAsserts.assertCheck(actualText,expectedText);

        actualText = driver.findElementById("com.sof.retail:id/checkBoxOrder").getText();
        expectedText = "By Order";TestAsserts.assertCheck(actualText,expectedText);

        actualText = driver.findElementById("com.sof.retail:id/checkBoxAll").getText();
        expectedText = "All";TestAsserts.assertCheck(actualText,expectedText);
    ...
    @Then("User Check Able to Edit Recurring Mini Page")
    public void user_Check_Able_to_Edit_Recurring_Mini_Page() throws InterruptedException {
    ...
    @Then("User Verify all in Recurring Mini Page")
    public void user_Verify_all_in_Recurring_Mini_Page() throws InterruptedException {
    ...
    @When("Check Product able to Remove In Recurring Mini Page")
    public void check_Product_able_to_Remove_In_Recurring_Mini_Page() throws InterruptedException, IOException {
        TouchAction action = new TouchAction(driver);
        ...
        String fileName="D:\\SOF-automation\\IMAF-main\\ScreenShots\\Recuringst" +".jpg";
