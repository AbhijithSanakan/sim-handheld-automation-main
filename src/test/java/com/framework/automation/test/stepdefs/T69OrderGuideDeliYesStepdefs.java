...
public class T69OrderGuideDeliYesStepdefs {
    static AndroidDriver<AndroidElement> driver;
    static int testCase=69;
    ...
    @Given("Verify on Login page and click Order Guide Page")
    public void verify_on_Login_page_and_click_Order_Guide_Page() throws IOException, InterruptedException {
    ...
    @Then("User in Contents Present Check at Deli Items Page")
    public void user_in_Contents_Present_Check_at_Deli_Items_Page() throws InterruptedException {
...
try{ MobileElement okk  = (MobileElement) driver.findElementById("com.sof.retail:id/positiveButton");
    okk.click();
    Thread.sleep(9000); }
catch (Exception e){System.out.println("LOW BACK STOCK COUNT");}
        }
        catch (Exception e){
            System.out.println("LOW BACK STOCK COUNT");
        }

        try{    MobileElement N  = (MobileElement) driver.findElementById("com.sof.retail:id/buttonConfirm");
        N.click();
        Thread.sleep(9000);}
        catch (Exception e){driver.findElementById("com.sof.retail:id/negativeButton").click();Thread.sleep(5000);}

        driver.findElementById("com.sof.retail:id/negativeButton").click();Thread.sleep(5000);

    }

    @Then("Check the all in Deli Items Page")
    public void check_the_all_in_Deli_Items_Page() throws InterruptedException {
        actualText = driver.findElementById("com.sof.retail:id/toolBarHeader").getText();
        expectedText = "Deli Items";
        TestAsserts.assertCheck(actualText,expectedText);

       try{ MobileElement can  = (MobileElement) driver.findElementById("com.sof.retail:id/positiveButton");
        can.click();
        Thread.sleep(9000);}
       catch (Exception e){MobileElement can  = (MobileElement) driver.findElementById("com.sof.retail:id/button3");
           can.click();Thread.sleep(9000);
       }

        try{ MobileElement Nxt1  = (MobileElement) driver.findElementById("com.sof.retail:id/buttonConfirm");
        Nxt1.click();
        Thread.sleep(8000);}
        catch (Exception e){MobileElement okk  = (MobileElement) driver.findElementById("com.sof.retail:id/positiveButton");
            okk.click();}

        try{MobileElement okk  = (MobileElement) driver.findElementById("com.sof.retail:id/negativeButton");
        okk.click();
        Thread.sleep(15000);}
        catch (Exception e){MobileElement okk  = (MobileElement) driver.findElementById("com.sof.retail:id/positiveButton");
            okk.click();}
    ...
    @When("Check in Back to Order Guide Deli Page Click Send")
    public void check_in_Back_to_Order_Guide_Deli_Page_Click_Send() throws InterruptedException, IOException {
        ...
        Value1.clear();Value1.sendKeys("20");
        Thread.sleep(5000);
...
//        Value3.click();Value3.sendKeys("10");
        ...
        ok.click();Thread.sleep(5000);}catch (Exception e){
        ...
        String fileName="D:\\SOF-automation\\IMAF-main\\ScreenShots\\69OrderDeli" +".jpg";
