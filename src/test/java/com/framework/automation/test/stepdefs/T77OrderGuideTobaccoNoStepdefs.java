...
public class T77OrderGuideTobaccoNoStepdefs {
    static AndroidDriver<AndroidElement> driver;
    static int testCase=77 ;
    ...
    @Given("Verify on Login page click Order Guide Page Items to Model")
    public void verify_on_Login_page_click_Order_Guide_Page_Items_to_Model() throws InterruptedException, IOException {
    ...
    @Then("User in Contents Present Click No Check at Tobacco Items Page")
    public void user_in_Contents_Present_Click_No_Check_at_Tobacco_Items_Page() throws InterruptedException {
        ...
        MobileElement clr  = (MobileElement) driver.findElementById("com.sof.retail:id/reviewQuantityValue");
        clr.clear();clr.sendKeys("20");
    ...
    @Then("Check the Bk all no in Tobacco Items Page")
    public void check_the_Bk_all_no_in_Tobacco_Items_Page() throws InterruptedException {
...
//        Thread.sleep(15000);
    ...
    @When("Check in Back to Order Guide Tobacco Page to Send Transact")
    public void check_in_Back_to_Order_Guide_Tobacco_Page_to_Send_Transact() throws InterruptedException, IOException {
